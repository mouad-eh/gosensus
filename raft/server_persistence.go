...
func (s *gRPCServer) setCurrentTerm(term int32) error {
	s.CurrentTerm = term
...
func (s *gRPCServer) setVotedFor(votedFor string) error {
	s.VotedFor = votedFor
...
func (s *gRPCServer) appendLog(entry LogEntry) error {
...
func (s *gRPCServer) trimLog(startIndex int32) error {
...
func (s *gRPCServer) setCommitLength(length int32) error {
